...
def get_raha_res(repitions, labeling_budgets, sandbox_path, results_path):
    algorithm = 'raha'
    result_df = get_results_df(sandbox_path, results_path, algorithm, repitions, labeling_budgets)
    total_results = get_total_results(labeling_budgets, repitions, result_df)
...
total_results = get_raha_res(repitions, labeling_budgets_raha, sandbox_path, results_path)
