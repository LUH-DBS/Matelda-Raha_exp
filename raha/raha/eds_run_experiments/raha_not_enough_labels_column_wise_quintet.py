...
logging.basicConfig(filename=f'/home/fatemeh/VLDB-Aug/results/raha-quintet/logs/raha-versions.log', level=logging.DEBUG)

repition = range(1, 6)
# labeling_budget = [0.10, 0.25, 0.5, 0.75, 1, 2, 3, 5, 10, 15, 20]
n_cols = 66
# labeling_budget_cells = [round(n_cols*x) for x in labeling_budget]
labeling_budget_cells = [10, 34]
labels_per_col_list = [2, 20]
sandbox_path = "/home/fatemeh/VLDB-Aug/EDS-Raha_exp/Raha/raha/datasets/Quintet"
...
if __name__ == "__main__":
   for exec_number in repition:
        for labels_per_col in labels_per_col_list:
            ...
            results_path = os.path.join("/home/fatemeh/VLDB-Aug/results/raha-versions/raha-quintet", f"exp_{exp_name}")
